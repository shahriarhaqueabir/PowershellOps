...
# Talon is at C:\Users\shahr\Documents\PowerShell\Talon\Talon.psd1
...
try {
    ...
    try {
        Import-Module -Name "C:\Users\shahr\Documents\PowerShell\Talon\Talon.psd1" -Force -ErrorAction Stop
